 ...
 *
 * Supports two modes:
 * 1. JAKE Proxy (if BUILT_IN_FORGE_API_URL and BUILT_IN_FORGE_API_KEY are set)
...
function getMapsConfig(): MapsConfig {
  ...
  console.warn(
    "[Maps API] No credentials configured. Using mock mode. Set GOOGLE_MAPS_API_KEY to enable real data."
  );
  return {
    mode: "mock",
  };
