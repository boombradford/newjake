...
- Database URL (MySQL)
- Google Maps API key OR Manus Forge credentials
- Manus OAuth credentials (for production auth)
...
### Manus OAuth (Production Authentication)
```bash
OAUTH_SERVER_URL=https://api.manus.app
VITE_OAUTH_PORTAL_URL=https://portal.manus.app
